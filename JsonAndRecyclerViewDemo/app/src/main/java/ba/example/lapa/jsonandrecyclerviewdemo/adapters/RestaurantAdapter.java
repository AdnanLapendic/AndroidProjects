package ba.example.lapa.jsonandrecyclerviewdemo.adapters;
...
import ba.example.lapa.jsonandrecyclerviewdemo.R;
import ba.example.lapa.jsonandrecyclerviewdemo.model.Restaurant;

/**
 * Created by lapa on 11/13/17.
 */
